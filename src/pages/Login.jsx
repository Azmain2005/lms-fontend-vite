...
const Login = () => {
  ...
  return (
    <div>
      ...
      >
        <div className="absolute inset-0 bg-orange-300 opacity-50 blur-md" />
          ...
          <div className="text-black">
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-4 text-lg">
                <input
                  className="rounded-3xl border-none bg-orange-400 px-6 py-2 text-center text-inherit placeholder-slate-200 shadow-lg outline-none backdrop-blur-md"
                  type="text"
                  name="email"
              ...
              <div className="mt-8 flex justify-center text-lg">
                <button
                  type="submit"
                  className="rounded-3xl bg-orange-400 bg-opacity-50 px-10 py-2 text-black border-4 border-orange-400 shadow-xl backdrop-blur-md transition-colors duration-300 hover:bg-orange-600 hover:text-white"
                >
                  Login
                </button>
              </div>
