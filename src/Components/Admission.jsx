...
const Admission = () => {
  ...
  return (
    <>
      <div id="admission">
      <p className="text-4xl font-bold text-center pt-10 text-orange-500 bg-white underline decoration-orange-500 decoration-2 underline-offset-4">
  All courses
</p>
              ...
              courses.map((course) => (
                <div key={course.id} className="w-full sm:w-1/2 md:w-1/3 p-2">
                  <Link to={`/course/${course.id}`} state={course}> {/* Use Link for navigation */}
                    <div className="shadow rounded-lg hover:border-2 border-orange-400">
