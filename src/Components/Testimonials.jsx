...
const Testimonials = () => {
  return (
    <div className="mt-20 pb-10">
      <section className="container w-full py-10 md:py-16 shadow-xl bg-orange-400 rounded-full">
        <div className="w-full px-[15px] mx-auto sm:max-w-[540px] md:max-w-[720px] lg:max-w-[1150px] xl:max-w-[1150px]">
          <div className="flex flex-col items-center gap-4 md:gap-10">
            <div className="flex flex-col items-center gap-4">
              <h1 className="text-ostad-black-100 text-h1 text-3xl font-bold text-center text-black">
                দেখে নিন কি বলছেন noman's Solution গ্র্যাজুয়েটরা
              </h1>
              <p className="text-body-paragraph text-ostad-black-80 text-center text-whtie">
